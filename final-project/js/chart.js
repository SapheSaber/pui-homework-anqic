...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function aggregateSpendingByCategory(records, year) {
        ...
        for (const date in records) {
            ...
            // default as other if the type is empty
            const categlory = spendingType && spendingType.trim() !== "" ? spendingType : "Other";

            console.log("Spending & Types: ", spending, spendingType);

            if (recordYear === year && spending > 0 && categories.hasOwnProperty(categlory)) {
                categories[categlory] += spending;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Update chart for different time frames (This Week, This Month, This Year)
    // This code chunk (line 317 - 334, 344 - 346) is refined/generated by ChatGPT
    function updateChart(buttonId, timeframe) {
        const now = new Date();
        let filteredData;
    ...
    document.getElementById('week-btn').addEventListener('click', () => updateChart('week-btn', 'This Week'));
    document.getElementById('month-btn').addEventListener('click', () => updateChart('month-btn', 'This Month'));
    document.getElementById('year-btn').addEventListener('click', () => updateChart('year-btn', 'This Year'));
});
